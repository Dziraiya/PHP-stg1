...
class __TwigTemplate_11421af0abc1fbccf6c1916de3a62051aecdf015e3bc59b1cbf5a7a8edef372d extends Template
{
    private $source;
    private $macros = [];
                    ...
                    if ( !twig_test_empty(twig_get_attribute($this->env, $this->source, $context["decision"], "voter_details", [], "any", false, false, false, 387))) {
                        ...
                        foreach ($context['_seq'] as $context["_key"] => $context["voter_detail"]) {
                            ...
                            echo "</td>
                                                            ";
                            // line 395
                            if ((twig_get_attribute($this->env, $this->source, (isset($context["collector"]) || array_key_exists("collector", $context) ? $context["collector"] : (function () { throw new RuntimeError('Variable "collector" does not exist.', 395, $this->source); })()), "voterStrategy", [], "any", false, false, false, 395) == twig_constant("Symfony\\Component\\Security\\Core\\Authorization\\AccessDecisionManager::STRATEGY_UNANIMOUS"))) {
                                // line 396
...
{% block panel %}
    ...
    {% endif %}
{% endblock %}
", "@Security/Collector/security.html.twig", "C:\\OpenServer\\domains\\gb\\vendor\\symfony\\security-bundle\\Resources\\views\\Collector\\security.html.twig");
    }
}
